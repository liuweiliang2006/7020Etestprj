...
#define MB_SPI_CS_ENABLE		HAL_GPIO_WritePin(SPI_CS2_GPIO_Port, SPI_CS2_Pin, GPIO_PIN_RESET) //低电平使能
#define MB_SPI_CS_DISABLE		HAL_GPIO_WritePin(SPI_CS2_GPIO_Port, SPI_CS2_Pin, GPIO_PIN_SET)
#define MB_SPI_CS_READ		 	HAL_GPIO_ReadPin(SPI_CS2_GPIO_Port,SPI_CS2_Pin)
